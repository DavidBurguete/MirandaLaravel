...
<div class="main__header">
    <div class="main__header__bg_color">
        <div class="main__header__text">
            ...
            <h4 class="main__header__text--details">The Perfect Base For You</h4>
        </div>
                ...
                <div class="room__card">
                    ...
                    <div class="room__card__bottom">
                        ...
                        <div class="room__card__bottom__pricing">
                            <p class="room__card__bottom__pricing__price">$345/Night</p>
...
<div class="menu">
    <img src="./img/cropped-donut.svg" alt="donut icon" class="menu__icon">
...
<div class="swiper swiper_complete">
    <div class="swiper-wrapper">
        <img src="./img/tartar.jpg" alt="a tartar image" class="swiper-slide food_image">
        <img src="./img/seafood.jpg" alt="some seafood image" class="swiper-slide food_image">
        <img src="./img/salmon.jpg" alt="a salmon-based dish image" class="swiper-slide food_image">
    </div>
    <div class="swiper-pagination"></div>
</div>
<div class="info">
